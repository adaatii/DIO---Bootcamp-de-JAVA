...
public class ExemploMap {
    public static void main(String[] args) {
        ...
        System.out.println(carrosPopulares);
        System.out.println("Remova os modelos com consumo de 15,6 km/l");
        ...
        System.out.println(carrosPopulare1.toString());

        System.out.println("Exiba ordenado pelo modelo: ");
        Map<String, Double> carrosPopulares2 = new TreeMap<>(carrosPopulare1);
        ...
        if (carrosPopulares.isEmpty()) System.out.println("Está vazio!");
